    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.CharField(default='-', max_length=200, null=True, verbose_name='Специальность')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='CMSWeb.Groups', verbose_name='Группа')),
